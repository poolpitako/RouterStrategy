...
def info():
    ...
    susd = Contract(Contract(strategy.resolver()).getAddress(encode_single("bytes32", b"Synthetix")))
    ...
    totalStakedAssets = (balanceOfSnx+strategy.balanceOfEscrowedWant()) / 1e18 * snxPrice
    ...
    print(f"    Total Balance of SNX: {(balanceOfSnx+strategy.balanceOfEscrowedWant())/1e18:_} SNX")
    ...
    print(f"    Balance of sUSD in Vault: {strategy.balanceOfSusdInVault()/1e18:_} sUSD")
